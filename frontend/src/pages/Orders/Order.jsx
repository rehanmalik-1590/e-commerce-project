...
const Order = () => {
    ...
    return isLoading ? (
        ...
        <div className="container mx-auto flex flex-col md:flex-row mt-8 px-4">
            {/* Order Items Section */}
            <div className="md:w-2/3 ml-[10rem] pr-4">
            ...
            {/* Shipping and Order Details Section */}
            <div className="md:w-1/3 md:ml-[5rem]">
                <div className="shadow-lg border border-gray-300 p-6 rounded-lg">
                    <h2 className="text-xl font-bold mb-4">Shipping & Order Details</h2>
                    <p className="mb-4">
